...
sys.path.insert(0, '../')
from variables import paths_from_model_gru as paths, tokens, _buckets, vocabulary_size, max_training_steps, steps_per_checkpoint, print_frequency, size, batch_size, num_layers, use_gpu
...
tf.app.flags.DEFINE_string("data_dir", "./Vinyals_gru_data", "Data directory")
tf.app.flags.DEFINE_string("train_dir", "./Vinyals_gru_data", "Training directory.")
tf.app.flags.DEFINE_string("log_dir", "./Vinyals_gru_data/log_dir", "Logging directory.")
