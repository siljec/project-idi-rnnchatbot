...
def create_final_files(source_path, vocabulary_path, train_path, val_path, test_path, val_size_fraction, test_size_fraction):
	...
	train_size = num_lines * (1 - val_size_fraction)
...
def generate_all_files(folders):
	...
	create_final_files(x_train_spell_check_path, vocabulary_path, x_train_final_path, x_val_path, x_test_path, val_size_fraction=0.1, test_size_fraction=0.1)
	create_final_files(y_train_spell_check_path, vocabulary_path, y_train_final_path, y_val_path, y_test_path, val_size_fraction=0.1, test_size_fraction=0.1)
